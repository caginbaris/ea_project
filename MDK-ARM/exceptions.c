...
void exceptions(void){
	...
	exception.bit.Ia_highLevel=on_off_delay(trueRMS.data.Ia>currentHighLimit,exception.bit.Ia_highLevel,fs,&exception_counters[3]);
	exception.bit.Ib_highLevel=on_off_delay(trueRMS.data.Ib>currentHighLimit,exception.bit.Ib_highLevel,fs,&exception_counters[4]);
	exception.bit.Ic_highLevel=on_off_delay(trueRMS.data.Ic>currentHighLimit,exception.bit.Ic_highLevel,fs,&exception_counters[5]);
